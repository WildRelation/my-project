package se.kth.jpsa2.labb3.shapes; // TODO: Change to your package name
...
public class World {
    ...
    public World(double width, double height) {
        ...
        shapes = new Shape[3]; // Ändra arrayens storlek till 3 för att ha plats för fler former

        // Skapa och lägg till en linje
        shapes[0] = new Line(0, 0, 100, 80, Color.RED);
        shapes[0].setVelocity(20, 40);

        // Skapa och lägg till en cirkel
        shapes[1] = new Circle(150, 150, 50, Color.BLUE, true);  // true betyder att cirkeln är fylld
        shapes[1].setVelocity(30, 30);

        // Skapa och lägg till en rektangel
        shapes[2] = new Rectangle(200, 100, 60, 40, Color.GREEN, false); // false betyder att rektangeln inte är fylld
        shapes[2].setVelocity(25, 35);
